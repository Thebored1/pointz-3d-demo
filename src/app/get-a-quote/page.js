    ...
    <div style={{ backgroundColor: 'var(--bg-primary)', minHeight: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <motion.div className="nat-hero" variants={heroContainer} initial="hidden" animate="visible">
        <motion.div variants={imageReveal} style={{ position: 'absolute', inset: 0 }}>
          <Image src="/images/fleet-hero.webp" alt="Point Zero Road Lines fleet lined up in the yard" fill sizes="100vw" priority style={{ objectFit: 'cover', objectPosition: 'center' }} />
        </motion.div>
