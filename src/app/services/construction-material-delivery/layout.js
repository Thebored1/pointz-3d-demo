export const metadata = {
  ...
  description: "On-time construction material delivery from Point Zero Road Lines, including flatbed and Moffett delivery direct to job sites across the GTA and Ontario.",
