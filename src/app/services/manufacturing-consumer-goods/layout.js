export const metadata = {
  ...
  description: "LTL and FTL freight services for manufacturers, distributors and retailers from Point Zero Road Lines - reliable capacity across the GTA and Ontario.",
