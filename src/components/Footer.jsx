      ...
      <div className="footer-container">
        ...
        <div className="footer-main">
          <div className="footer-brand-col">
            ...
            >
              <img src="/assets/logo.png?v=3" alt="Point Zero Road Lines" style={{ height: '60px', objectFit: 'contain', marginBottom: '1rem', background: '#fff', padding: '10px', borderRadius: '4px' }} />
            </motion.div>
            <motion.p 
